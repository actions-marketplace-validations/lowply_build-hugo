...
- Utilizes [Hugo extended version 0.163.2](https://github.com/gohugoio/hugo/releases/tag/v0.163.2)
...
jobs:
  build:
    ...
    - name: Build Hugo
      uses: lowply/build-hugo@v0.163.2
```
...
```
docker run --rm -w /tmp -v $(pwd):/tmp lowply/build-hugo:v0.163.2
```
